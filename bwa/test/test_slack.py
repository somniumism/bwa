...
from bwa.send_slack import deco_noti, send_noti
...
class SlackTest(unittest.TestCase):
    ...
    def test_decorator_with_custom_content(self):
        @deco_noti(webhook_url=webhook_url, custom_content="Hello, Slack")
        def decorator_with_custom_content():
            sleep(3)
        decorator_with_custom_content()

    def test_decorator_with_custom_content_true(self):
        @deco_noti(webhook_url=webhook_url, custom_content="Hello, Slack", notify_end_too=True)
        def decorator_with_custom_content_true():
            sleep(3)
        decorator_with_custom_content_true()

    def test_function(self):
        send_noti(webhook_url=webhook_url, custom_content="Hello, Slack")
    ...
    def test_simple_function_with_custom_content(self):
        send_noti(custom_content="Hello, Slack")
