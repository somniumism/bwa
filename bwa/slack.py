# Simple Notification Sender for Slack
# Author: SeungMin Lee,
...
class WebhookUrlEnteredError(Exception):
    def __init__(self):
        super().__init__("No webhook url entered; Please make sure that you entered `webhook_url` or the environment variable `SLACK_WEBHOOK_URL` correctly.")
